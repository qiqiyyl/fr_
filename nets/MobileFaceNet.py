...
# shallow_1
# _CONV_DEFS = [
#     Conv(kernel=[3, 3], stride=2, depth=16, ratio=1),
#     DepthwiseConv(kernel=[3, 3], stride=1, depth=16, ratio=1),
#
#     InvResBlock(kernel=[3, 3], stride=2, depth=16, ratio=2, repeate=4),
#     InvResBlock(kernel=[3, 3], stride=2, depth=32, ratio=4, repeate=1),
#     InvResBlock(kernel=[3, 3], stride=1, depth=32, ratio=2, repeate=5),
#     InvResBlock(kernel=[3, 3], stride=2, depth=32, ratio=4, repeate=1),
#     InvResBlock(kernel=[3, 3], stride=1, depth=32, ratio=2, repeate=2),
#
#     # Conv(kernel=[1, 1], stride=1, depth=128, ratio=1),
# ]
...
#     DepthwiseConv(kernel=[3, 3], stride=1, depth=16, ratio=1),
#
#     InvResBlock(kernel=[3, 3], stride=2, depth=16, ratio=2, repeate=3),
#     InvResBlock(kernel=[3, 3], stride=2, depth=32, ratio=4, repeate=1),
#     InvResBlock(kernel=[3, 3], stride=1, depth=32, ratio=2, repeate=4),
#     InvResBlock(kernel=[3, 3], stride=2, depth=32, ratio=4, repeate=1),
#     InvResBlock(kernel=[3, 3], stride=1, depth=32, ratio=2, repeate=2),
#
#     # Conv(kernel=[1, 1], stride=1, depth=128, ratio=1),
...
def mobilenet_v2_arg_scope(is_training=True,
  ...
  with slim.arg_scope([slim.conv2d, slim.separable_conv2d],
                      ...
                      activation_fn=tf.nn.relu6, normalizer_fn=slim.batch_norm): #tf.keras.layers.PReLU
