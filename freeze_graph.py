...
def get_parser():
    ...
    parser.add_argument('--pretrained_model', type=str, default='./checkpoint/demo/MobileFaceNet_epoch_0016_acc_0.9392.ckpt',
                        help='Load a pretrained model before training starts.')
    parser.add_argument('--output_file', type=str, help='Filename for the exported graphdef protobuf (.pb)', default='./checkpoint/demo/freeze.pb')
...
if __name__ == '__main__':
    with tf.Graph().as_default():
        ...
        # define placeholder
        inputs = tf.placeholder(name='img_inputs', shape=[1, 112, 112, 1], dtype=tf.float32)
        labels = tf.placeholder(name='img_labels', shape=[1, ], dtype=tf.int64)
